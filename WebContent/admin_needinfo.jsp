...
out.println("<br>");
out.println("<div class='bt' num="+need.getNum()+" onMouseOut=this.style.backgroundColor='aqua' onMouseOver=this.style.backgroundColor='red' id='pass'><strong>通&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;过</strong></div>");
out.println("<br>");
out.println("<div class='bt' num="+need.getNum()+" onMouseOut=this.style.backgroundColor='aqua' onMouseOver=this.style.backgroundColor='red' id='reject'><strong>退&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回</strong></div>");
%>
</center>
</body>
</html>
...
function getPassResult(data){
	if(data=="1"){
		alert("审核成功，已通过！",function(){window.location.reload();});
	}
	else{
		alert("审核失败！");
	}
}
function getRejectResult(data){
	if(data=="1"){
		alert("审核成功，已退回！",function(){window.location.reload();});
	}
	else{
		alert("审核失败！");
	}
...
$("#pass").click(
	function(){
		$.post("UpdateNeedServlet",
			getParams($(this).attr("num"),"已通过"),
			function(data){getPassResult(data);});	
	}
);
$("#reject").click(
	function(){
		$.post("UpdateNeedServlet",
			getParams($(this).attr("num"),"被退回"),
			function(data){getRejectResult(data);});	
	}
);
</script>